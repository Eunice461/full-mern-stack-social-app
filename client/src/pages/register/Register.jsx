...
<label className='label-general'>FirstName</label>
                    <input className='input-general registerInput' type="text" placeholder='Enter your firstname'
                        onChange={e=>setFirstName(e.target.value)}
                    />

<label className='label-general'>LatName</label>
                    <input className='input-general registerInput' type="text" placeholder='Enter your lastname'
